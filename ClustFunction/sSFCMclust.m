function [V_pc,V_pe,Vxb] = sSFCMclust(data, cluster_n,data_label)%data_label是30*14维，包括标签,data_label0是30*13维，不包括标签
...
center0 = rand(cluster_n,size(data,2));     %随机初始聚类中心
